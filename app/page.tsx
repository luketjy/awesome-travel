...
function HeroCarousel({ tours, onSelect }: { tours: any[]; onSelect: (t: any) => void }) {
    ...
    <div className="relative w-full overflow-hidden">
      <div className="relative h-[70vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-20 max-w-2xl p-6 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 drop-shadow-lg">{active.title}</h2>
...
<div className="absolute bottom-4 left-0 right-0 flex items-center justify-between px-6 z-10">
  <button onClick={goPrev} className="button-74" role="button">
    ◀
  </button>
  <button onClick={goNext} className="button-74" role="button">
    ▶
  </button>
</div>
